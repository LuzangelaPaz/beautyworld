    ...
    return (
        <main id="banner" className={styles.layer} style={{ backgroundImage: `url(${banner})`, '--primary-color': primaryColor }}>
            ...
            <section className={styles.content}>
                ...
                <h2 className={styles.title}>El mundo de la belleza</h2>
                <p className={styles.subtitle}>
                ¡Aquí encontrarás tutoriales, reseñas y tips de maquillaje, skincare y estilo de vida, todo en un solo lugar. ¡Explora, inspírate y transforma tu rutina de belleza con las expertas más influyentes del momento!
                </p>
